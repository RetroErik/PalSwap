; ============================================================================
; EVGAPAL.ASM - CGA Palette Override TSR for EGA and VGA cards
...
;
; HOW IT WORKS:
;   1. You run EVGAPAL [/1..5 | file.txt] before the game.
;   2. EVGAPAL loads the palette, hooks INT 10h, and stays resident (TSR).
...
;   5. Run "EVGAPAL /U" to uninstall the TSR when done.
;
...
;
; Usage:  EVGAPAL [file.txt] [/1] [/2] [/3] [/4] [/5] [/R] [/U] [/?]
...
;   /?         Show help
;   file.txt   Load colours from a text file (default: EVGAPAL.TXT)
;
...
; ============================================================================
msg_banner:
    db 'EVGAPAL v2.0 - CGA Palette TSR for EGA/VGA', 13, 10
...
msg_installed:
    ...
    db 'Run your CGA game now. Use EVGAPAL /U to uninstall.', 13, 10, '$'
msg_already_loaded:
    db 'EVGAPAL TSR already installed.', 13, 10
    db 'Use EVGAPAL /U to uninstall first, then reinstall with new palette.', 13, 10, '$'
msg_unloaded:
    db 'EVGAPAL TSR uninstalled. INT 10h restored.', 13, 10, '$'
msg_unload_error:
    db 'Error: EVGAPAL TSR not found in INT 10h chain.', 13, 10, '$'

msg_help:
    db 13, 10
    db 'Usage: EVGAPAL [file.txt] [/1..5] [/R] [/U] [/?]', 13, 10, 13, 10
    ...
    db '  /R  Default palette   /U  Uninstall TSR   /?  This help', 13, 10
